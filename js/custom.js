...
*/
$( function() {
        var endDate = "September 3, 2019 12:00:00";
        ...
        $('.countdown.styled').countdown({
          ...
          render: function(data) {
            $(this.el).html("<div>" + this.leadingZeros(data.days, 3) + " <span>дней</span></div><div>" + this.leadingZeros(data.hours, 2) + " <span>час</span></div><div>" + this.leadingZeros(data.min, 2) + " <span>минут</span></div><div>" + this.leadingZeros(data.sec, 2) + " <span>секунд</span></div>");
          }
        });
